all: main.o matrixInput.o gauss_func.o matrixOutput.o results.o otherFunctions.o
	g++ main.o matrixInput.o gauss_func.o matrixOutput.o results.o otherFunctions.o
